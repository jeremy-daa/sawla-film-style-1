  ...
  return (
    ...
    >
      <div className="bg-black/80 backdrop-blur-lg border border-white/10 rounded-full p-2 pl-6 pr-2 shadow-2xl flex items-center gap-4">
          <span className="text-white text-sm font-medium hidden sm:inline">Start your production</span>
          
          <div className="flex items-center gap-2">
              <Button size="icon" variant="ghost" className="text-white hover:bg-white/10 rounded-full w-10 h-10">
