...
export function Footer() {
  return (
    <footer className="w-full bg-zinc-950 text-white border-t border-white/10">
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          <div className="col-span-1 md:col-span-1">
            <Link
              href="/"
              className="text-2xl font-serif font-bold text-white tracking-wider block mb-6"
            >
              SAWLA FILMS
            </Link>
            <p className="text-zinc-500 text-sm leading-relaxed mb-6">
              Sawla Films pairs world-class storytelling with bulletproof film
              logistics Ethiopia wide—location scouting, filming permits, gear
              import & onset fixers.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-zinc-500">
              <li>
                <FooterLink href="/services/permits">
                  Permit Handling
                </FooterLink>
              </li>
              <li>
                <FooterLink href="/services/scouting">
                  Location Scouting
                </FooterLink>
              </li>
              <li>
              ...
              <li>
                <FooterLink href="/services/crew">
                  Crew & Tech Support
                </FooterLink>
              </li>
              <li>
                <FooterLink href="/services/remote">Remote Camps</FooterLink>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-zinc-500">
              ...
              <li>
                <FooterLink href="/guide">Filming Guide</FooterLink>
              </li>
              <li>
        ...
        <div className="border-t border-white/5 mt-16 pt-8 flex flex-col md:flex-row items-center justify-between text-xs text-zinc-600">
          <p>
            &copy; {new Date().getFullYear()} Sawla Films. All rights reserved.
          </p>
